...
public class SlidingExpandableListView extends ExpandableListView {
    ...
    public SlidingExpandableListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * A specialized adapter for use with the SlidingExpandableListView. All
     * adapters used with SlidingExpandableListView MUST extend this class.
     */
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private SlidingExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(SlidingExpandableListView parent) {
            this.parent = parent;
        }
